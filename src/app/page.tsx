...
import { Radio, Zap, Scale, Bell, Shield, ArrowRight, Check } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between border-b border-gray-800 pb-3">
          <div className="flex items-center gap-2">
            <h2 className="text-xl font-bold text-white tracking-tight">Real-Time Market Events</h2>
            <span className="px-2 py-0.5 text-[11px] font-mono rounded bg-cyan-950/60 text-cyan-400 border border-cyan-800/50">
              {eventsData.events.length} tracked
            </span>
          </div>
          <Link
            href="/feed.xml"
      ...
      <section className="pt-6 border-t border-gray-800 space-y-6">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <h2 className="text-2xl font-extrabold text-white">Developer &amp; Enterprise Tiers</h2>
