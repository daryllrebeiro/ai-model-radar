...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Price drop forecasts (RadarForecast)', included: true },
      { text: 'Switch-and-save migration recommendations', included: true },
      { text: 'Live endpoint probes & reliability', included: true },
      { text: 'Ask the Radar copilot', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Budget governance & shadow-AI detection', included: true },
...
const comparisonRows = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Price drop forecasts', free: false, pro: true, enterprise: true },
      { label: 'Switch-and-save recommendations', free: 'Advisor only', pro: true, enterprise: 'Team budgets' },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Live endpoint probes', free: false, pro: true, enterprise: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Ask the Radar copilot', free: false, pro: true, enterprise: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Budget governance & shadow-AI', free: false, pro: false, enterprise: true },
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {[
          ...
          },
          {
            ...
            a: 'AI Model Radar is an event-sourced market changelog, not a pricing table. We track every price drop, new release, free tier change, and context expansion in real time, with anomaly detection, multi-provider arbitrage, and cost optimization tools — plus predictive price-drop forecasts, live endpoint probes that verify free tiers actually serve traffic, team budget governance with shadow-AI detection, and an Ask-the-Radar copilot that answers questions with citations.',
          },
        ].map((faq) => (
